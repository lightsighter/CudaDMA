...
main( int argc, char** argv) 
{
  ...
  float f_gflops = static_cast<float>(2.*((float)mem_size/4.)*(float)COMPUTE_THREAD_ITERS*((float)ACTIVE_COMPUTE_THREADS_PER_CTA/(float)COMPUTE_THREADS_PER_CTA))/ f_time / static_cast<float>(1000000.0);;
