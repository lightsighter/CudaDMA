...
def run_experiment(test_k20,gather,alignment,offset,register_bytes,elem_size,num_elmts,dma_warps,random_seed):
...
def run_random_experiments(test_k20):
    ...
    while True:
        ...
        #else:
        #    below += 1
        run_experiment(test_k20,gather,alignment,offset,register_bytes,elem_size,num_elems,warps,random_seed)
