...
template<int ALIGNMENT, int ALIGN_OFFSET, int BYTES_PER_ELMT, int DMA_THREADS, int NUM_TEMPLATE_PARAMS>
...
int main()
{
  fprintf(stdout,"Experiment: ALIGNMENT-%2d OFFSET-%d ELMT_SIZE-%5d DMA_WARPS-%2d NUM_TEMPLATES-%d ",PARAM_ALIGNMENT,PARAM_OFFSET,PARAM_ELMT_SIZE,PARAM_DMA_THREADS/WARP_SIZE,PARAM_NUM_TEMPLATES);
  fflush(stdout);
  bool result = run_experiment<PARAM_ALIGNMENT,PARAM_OFFSET,PARAM_ELMT_SIZE,PARAM_DMA_THREADS,PARAM_NUM_TEMPLATES>();
