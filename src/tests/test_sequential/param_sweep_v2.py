...
def run_experiment(test_k20,alignment,offset,register_bytes,elem_size,dma_warps):
...
def run_random_experiments(test_k20):
    ...
    while True:
        ...
        #else:
        #    below += 1
        run_experiment(test_k20,alignment,offset,register_bytes,elem_size,warps)
